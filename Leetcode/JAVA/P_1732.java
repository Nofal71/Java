public class P_1732 {
    ...
    // LEETCODE PROBLEM 1732 :- Highest altitude in given array as gain is net , and first point has zero altitude :-

    public static int largestAltitude(int[] gain) {

        int highest = 0 ;
        int[] altitude = new int[gain.length+1]; // As one extra itration , so preventing from out of bounds exeptions....
